...
const totalNotasEmitidasElement = document.getElementById('total-notas-emitidas');
const totalNotasDevolvidasElement = document.getElementById('total-notas-devolvidas');
...
adicionarButton.addEventListener('click', (e) => {
  ...
  const notasEmitidas = parseInt(document.getElementById('notas-emitidas').value);
  const notasDevolvidas = parseInt(document.getElementById('notas-devolvidas').value);

  if (!isNaN(notasDevolvidas) && !isNaN(notasEmitidas) && !isNaN(notasDevolvidas)) {
